...
| 🟠 Later | **Wire Athlete Profile → Athlete App: Metrics sync** — body metrics and performance values entered by coach appear in athlete app; values logged by athlete auto-update coach profile. | ✅ Done |

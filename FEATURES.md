...
|---|---|---|
| 🟠 Later | **Exercise comments & coach feedback** — text comments already work (athlete + coach, visible in CompletedSessionSheet). Remaining: media upload (video, images, documents) so athletes can share form clips or coach can attach reference material. | ⬜ Open |

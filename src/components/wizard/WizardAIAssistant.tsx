...
- add_exercise: {"type":"add_exercise","exerciseId":"<exact exerciseId>","exerciseName":"<name>","libraryId":"<exact libraryId>","methodId":"<exact method name>","dayDate":"YYYY-MM-DD","sessionIndex":0,"sectionName":"<exact section name or omit>"}

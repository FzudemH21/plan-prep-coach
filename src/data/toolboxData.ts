...
export const defaultToolboxData: LegacyToolboxDatabase = {
  entries: [
    ...
    { id: "138", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Frequency", exerciseCategories: ["Squat", "Hinge"] },
    { id: "139", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Organization [Regular Sets, SuperSets, Tri-Sets, Giant Sets, Contrast Sets, French Contrast Method, Complex Sets]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "140", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Sets [#]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "141", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Set Type [Pyramid, Inverse Pyramid, Drop, Cluster Sets, Rest-Pause, Myo-Reps]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "142", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Reps [#]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "143", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Rep Set-Up [Straight, AMRAP, Density, Forced Reps, Cheat Reps, Velocity Threshold [m/s], Velocity Drop-off [%]]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "144", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Intensity [%1RM, RPE, RiR, Mean velocity [m/s]]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "145", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Loading Method [Isotonic, Isokinetic, Accomodating resistance, Isoinertial, Accentuated eccentric]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "146", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Contraction type [Dynamic, Eccentric-only, Concentric only, Ballistic]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "147", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Range of motion [full, partial (specify)]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "148", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Tempo [Xs-Xs-Xs-Xs]", exerciseCategories: ["Squat", "Hinge"] },
    { id: "149", category: "Lower Body Resistance Training", subCategory: "Strength", parameter: "Inter-Set Rest Duration [s]", exerciseCategories: ["Squat", "Hinge"] },
